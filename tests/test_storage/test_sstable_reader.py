...
from python_kv.storage.sstable_reader import SSTableReader

def test_get_index_from_binary():
    memtable =  MemTable()
    memtable.put(1, 1)
    memtable.put(2, 2)
    memtable.put(3, 3)
    ...
    index = reader.get_index_from_binary(b'\x93\xac\x16\x94\x00\x00\x00\x00\x17\xe2)\x01\x0c\x00\x00\x00\xb4\xa1\xc7\x0f\x17\x00\x00\x00')
